...
var GithubHelper = /** @class */ (function () {
    ...
    GithubHelper.prototype.getFileContent = function (path, ref) {
    ...
    ;
    GithubHelper.prototype.getFile = function (path, ref) {
        return __awaiter(this, void 0, void 0, function () {
            var repo, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    GithubHelper.prototype.getFiles = function () {
        return __awaiter(this, void 0, void 0, function () {
            var compare, files;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.context.github.repos.compareCommits(this.context.repo({
                    ...
                    case 1:
                        ...
                        files = compare.data.files
                            .filter(function (file) { return file.status === "modified"; })
    ...
    ;
    GithubHelper.prototype.getRef = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ref;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    GithubHelper.prototype.getTree = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ref, tree;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    GithubHelper.prototype.createBlob = function (content) {
        return __awaiter(this, void 0, void 0, function () {
            var blob;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    GithubHelper.prototype.createStatus = function (state, description) {
        return __awaiter(this, void 0, void 0, function () {
            var head, status, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        head = this.pr.head;
    ...
    ;
    GithubHelper.prototype.getComments = function () {
        return __awaiter(this, void 0, void 0, function () {
            var comments;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    GithubHelper.prototype.createComment = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.context.github.issues.createComment(this.context.repo({ number: this.pr.number, body: body }))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.data];
                }
    ...
    ;
    GithubHelper.prototype.editComment = function (body, comment_id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.context.github.issues.editComment(this.context.repo({
                            number: this.pr.number,
                            body: body,
    ...
    ;
    GithubHelper.prototype.createCommit = function (files) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        newTree = _a.sent();
                        return [4 /*yield*/, github.gitdata.createCommit(context.repo({
                                message: "Reverting changes of " + files.length + " files that only had formatting changes",
                                tree: newTree.data.sha,
                                parents: [basetree.sha]
                            }))];
                    case 4:
                        commit = _a.sent();
                        return [4 /*yield*/, github.gitdata.updateReference(context.repo({
                                number: this.pr.number,
                                sha: commit.data.sha,
