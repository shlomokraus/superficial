        ...
        this.getFiles = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        compare = _a.sent();
                        files = compare.data.files.filter(function (file) { return file.status === "modified"; }).map(function (file) { return file.filename; });
        ...
        this.createCommit = function (files) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        newTree = _a.sent();
                        return [4 /*yield*/, github.gitdata.createCommit(context.repo({ message: "Reverting changes of " + files.length + " files that only had formatting changes", tree: newTree.data.sha, parents: [basetree.sha] }))];
                    case 4:
                        commit = _a.sent();
