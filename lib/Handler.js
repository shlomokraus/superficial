...
var botIdentifier = "superficialbot[bot]";
...
var Handler = /** @class */ (function () {
    function Handler(context, pr) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getFile(path, base)];
                    case 1:
                        source = _a.sent();
        ...
        this.postComment = function (items, errors) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var context, files, comment, existing;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        filtered = this.filterFiles(files);
                        return [2 /*return*/, filtered];
                }
            });
        }); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getFileContent(path, headRef)];
                    case 1:
                        head = _a.sent();
                        baseRef = this.pr.base.ref;
                        return [4 /*yield*/, this.getFileContent(path, baseRef)];
                    case 2:
                        base = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        this.githubHelper = new Github_1.Github(context, pr);
        this.pr = pr;
    }
    Handler.prototype.handle = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, problematic, errors, revertPaths, revert;
            var _this = this;
    ...
    Handler.prototype.check = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFiles()];
                    case 1:
                        files = _a.sent();
