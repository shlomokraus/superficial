...
var Handler = /** @class */ (function () {
    ...
    Handler.prototype.compareFiles = function (source, target, filename) {
        ...
        var left = isScript ? Parser_1.Parser.parse(source, filename) : Parser_1.Parser.prepare(source, { filepath: filename });
        var right = isScript ? Parser_1.Parser.parse(target, filename) : Parser_1.Parser.prepare(target, { filepath: filename });
