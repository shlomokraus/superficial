...
var scriptExtensions = ["ts", "js", "tsx", "jsx"];
...
var Handler = /** @class */ (function () {
    function Handler(context) {
        ...
        this.postComment = function (items, errors) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var context, files, comment, existing, body, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 5:
                            body = _a;
                            return [4 /*yield*/, context.github.issues.editComment(context.repo({
    ...
    Handler.prototype.handle = function (prNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var isComment, shouldRevert, pr, _a, problematic, errors, payload, files, revertPaths, revert;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        this.persist = new Persist_1.Persist(this.context, this.context.repo({ number: prNumber }));
                        if (!!shouldRevert) return [3 /*break*/, 8];
                        this.context.log.debug("Starting check run");
                        return [4 /*yield*/, this.check()];
                    case 3:
                        _a = _b.sent(), problematic = _a.problematic, errors = _a.errors;
                        this.context.log.debug("Check completed with " +
                            problematic.length +
                            " files and " +
                            errors.length +
                            " errors");
                    ...
                    case 5:
                        _b.sent();
                        if (!(problematic.length > 0)) return [3 /*break*/, 7];
                    ...
                    case 10:
                        revert = _b.sent();
                        if (!(revert.length > 0)) return [3 /*break*/, 14];
    ...
    Handler.prototype.compareFiles = function (source, target, filename) {
        ...
        var isScript = scriptExtensions.indexOf(ext) >= 0;
        var left = isScript
